...
interface BudgetCardProps {
  filteredRepairCost?: number;
}

function BudgetCard({ filteredRepairCost }: BudgetCardProps) {
  const {
    currentBudget,
  ...
  // Get estimation totals - use filtered cost if provided
  const estimatedRepairCosts = filteredRepairCost !== undefined ? filteredRepairCost : getEstimatedRepairCosts();
