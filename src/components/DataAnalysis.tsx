          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            ...
            >
              <div>
                ...
                <p className="text-lg sm:text-xl font-bold text-gray-900  mb-1">{kpiMetrics.upgradePercentage}% upgraded</p>
                <p className="text-xs text-gray-500  leading-tight">{kpiMetrics.upgradeStats.upgraded} of {kpiMetrics.upgradeStats.total} devices upgraded</p>
              </div>
            </div>
            ...
            >
              <div>
                <p className="text-xs font-medium text-gray-600  mb-1">Processor</p>
                <p className="text-lg sm:text-xl font-bold text-gray-900  mb-1">{kpiMetrics.processorBelowSpec}% below spec</p>
                <p className="text-xs text-gray-500  leading-tight">{kpiMetrics.processorStats.belowSpec} devices need CPU upgrade</p>
              </div>
            </div>
            ...
            >
              <div>
                <p className="text-xs font-medium text-gray-600  mb-1">RAM</p>
                <p className="text-sm sm:text-lg font-bold text-gray-900  mb-1 leading-tight">
                ...
                <p className="text-xs text-gray-500  leading-tight">RAM availability across devices</p>
              </div>
            </div>
          </div>
