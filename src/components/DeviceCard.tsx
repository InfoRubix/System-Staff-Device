        ...
        <div className="px-2 sm:px-3 md:px-4 pb-3 sm:pb-4 bg-gradient-to-b from-gray-50/50 to-white border-t border-gray-100">
          ...
          <div className="mt-3 sm:mt-4 space-y-3 sm:space-y-4 md:space-y-6">
            ...
            <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 shadow-sm border border-gray-100">
              <button 
                className="w-full flex items-center justify-between cursor-pointer select-none hover:bg-gray-50 p-2 rounded-lg transition-colors"
                onClick={(e) => {
                  e.stopPropagation();
              ...
              >
                ...
                <div className="text-sm text-gray-500 font-medium">View Details</div>
              </button>
            </div>

            {/* Hardware Specifications Button */}
            <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 shadow-sm border border-gray-100">
              <button 
                className="w-full flex items-center justify-between cursor-pointer select-none hover:bg-gray-50 p-2 rounded-lg transition-colors"
                onClick={(e) => {
        ...
        >
          ...
          >
            ...
            <div className="p-6 space-y-4">
              <div className="flex flex-col space-y-3 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg border border-gray-200 p-4">
                <div className="flex items-center space-x-3">
        ...
        >
          ...
          >
            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-lg"></div>
                  <h3 className="text-xl font-bold text-gray-900">Hardware Specifications</h3>
                </div>
                <button
                  onClick={() => setShowHardwareModal(false)}
                  className="text-gray-400 hover:text-gray-600 transition-colors p-2 hover:bg-gray-100 rounded-full"
            ...
            <div className="p-6 space-y-4">
              <div className="flex flex-col space-y-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200 p-4">
                <div className="flex items-center space-x-3">
